@echo off
chcp 65001 > nul
echo 🚀 Concatenando TCC Resumido...

set "TCC_DIR=c:\Programacao\tcc\docs\07-tcc-resumido"
set "OUTPUT_FILE=TCC-RESUMIDO-COMPLETO.md"
...
echo.
echo ✅ TCC Resumido concatenado com sucesso!
...
echo    - Páginas estimadas: ~15-20 páginas

echo.
echo 📋 Conversão para PDF:
echo    - Pandoc: pandoc %OUTPUT_FILE% -o TCC-RESUMIDO.pdf
